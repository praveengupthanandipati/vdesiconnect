      ...
      <div className="product-card__img-wrap">
        ...
        {outOfStock ? (
          ...
          <div className="product-card__overlay">
            <button className="product-card__cart-btn" aria-label="Add to cart" onClick={handleAddToCart}>
              <CartIcon size={17} />
              Add to Cart
            </button>
            <button className="product-card__wish-btn" aria-label="Wishlist" onClick={stopNav}>
              <HeartIcon size={17} />
            </button>
          </div>
        )}
